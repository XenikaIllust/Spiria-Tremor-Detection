...
class StateMachine():
    ...
    def set_button_actions(self):
        ...
        self.ui.pairing_failed_button.clicked.connect(partial(self.set_state, PAIRING_STATE))
    ...
    def pairing(self):
        ...
        self.ui.pairing_start_button.setVisible(False)
        self.ui.pairing_continue_button.setVisible(status)
        self.ui.pairing_failed_button.setVisible(not(status))
